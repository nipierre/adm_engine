...
int renderAdmContent(const std::string& input, const std::string& destination, const std::map<std::string, float>& elementGains) {
...
int main(int argc, char **argv) {
  ...
  if(outputDirectoryPath.empty()) {
    ...
    return renderAdmContent(inputFilePath, outputDirectoryPath, elementGains);
  }
}
